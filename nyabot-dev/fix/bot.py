...
class Bot:
    ...
    _event_send_stream: MemoryObjectSendStream[
        EventHandleOption
    ]  # pyright: ignore[reportUninitializedInstanceVariable]
    _event_receive_stream: MemoryObjectReceiveStream[
        EventHandleOption
    ]  # pyright: ignore[reportUninitializedInstanceVariable]
    _condition: (
        anyio.Condition
    ...
    _should_exit: (
        anyio.Event
    )  # 机器人是否应该进入准备退出状态 # pyright: ignore[reportUninitializedInstanceVariable]
